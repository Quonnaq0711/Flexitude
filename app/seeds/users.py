...
def seed_user():
    demo = User(
        firstname='Demolition',lastname='crew', username='Demo', email='demo@aa.io', password='password')
    marnie = User(
        firstname='Mary',lastname='berry',username='marnie', email='marnie@aa.io', password='password')
    bobbie = User(
